...
Page {
    ...
    property string pageName: "Ostatní návěsti"
            ...
            contentItem: Item {
                ...
                Canvas {
                    ...
                    onPaint: {
                        ...
                        ctx.beginPath()
                        ctx.moveTo(width / 2, 0)        // vrchol nahoře
                        ctx.lineTo(0, height)           // levý spodní
                        ctx.lineTo(width, height)       // pravý spodní
                        ctx.closePath()
                        ctx.fill()
                    }
                }
