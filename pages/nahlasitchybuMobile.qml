...
Page {
    ...
    Component.onCompleted: {
        ...
        console.log("Přišel argument:", fromPagepath)
        zmenstranku()
    }
                ...
                Rectangle {
                    ...
                    Column {
                        ...
                        ComboBox {
                            ...
                            indicator: Canvas {
                                id: canvas
                                anchors.verticalCenter: parent.verticalCenter   // svisle vycentrované
                                    anchors.right: parent.right
                                    anchors.rightMargin: 10   // odsazení od pravého okraje
                                width: 12
                                height: 8
                                contextType: "2d"
