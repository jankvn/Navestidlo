...
0xb4,0xf,0x0,0x0,0x35,0x35,0x37,0x61,
...
void markObjects(QV4::MarkStack *markStack) const final {    Q_UNUSED(markStack);
    ...
    aotContext->mark(v7_21, markStack);
}
...
s.v2_15 = QVariant::fromValue(QStringLiteral("qrc:/pages/nahlasitchybuDesktop.qml"));
{
}
// generate_Jump
{
...
label_0:;
// generate_LoadRuntimeString
s.v2_19 = QVariant::fromValue(QStringLiteral("qrc:/pages/nahlasitchybuMobile.qml"));
{
s.v7_21 = std::move(s.v2_19);
}
label_1:;
// generate_StoreReg
{
...
// generate_LoadRuntimeString
s.v2_27 = QStringLiteral("Loading page:");
{
}
// generate_StoreReg
{
...
#endif
while (!aotContext->loadContextIdLookup(3, &s.v2_38)) {
#ifdef QT_NO_DEBUG
aotContext->setInstructionPointer(40);
#endif
...
#endif
while (!aotContext->getObjectLookup(4, s.v2_38, &s.v2_40)) {
#ifdef QT_NO_DEBUG
aotContext->setInstructionPointer(42);
#endif
aotContext->initGetObjectLookup(4, s.v2_38);
if (aotContext->engine->hasError()) {
aotContext->setReturnValueUndefined();
return;
}
...
// generate_CallPropertyLookup
{
    ...
    if (category && category->isEnabled(QtDebugMsg)) {
        const QString message = std::move(s.v2_27).append(QLatin1Char(' ')).append(aotContext->engine->fromVariant<QString>(s.v7_21)).append(QLatin1Char(' ')).append(std::move(s.v2_34)).append(QLatin1Char(' ')).append(std::move(s.v2_40));
...
#endif
while (!aotContext->loadContextIdLookup(6, &s.v2_49)) {
#ifdef QT_NO_DEBUG
aotContext->setInstructionPointer(51);
#endif
...
#endif
while (!aotContext->loadContextIdLookup(7, &s.v2_56)) {
#ifdef QT_NO_DEBUG
aotContext->setInstructionPointer(58);
#endif
...
#endif
while (!aotContext->getObjectLookup(8, s.v2_56, &retrieved)) {
#ifdef QT_NO_DEBUG
aotContext->setInstructionPointer(60);
#endif
aotContext->initGetObjectLookup(8, s.v2_56);
if (aotContext->engine->hasError()) {
aotContext->setReturnValueUndefined();
return;
}
...
#endif
while (!aotContext->loadContextIdLookup(9, &s.v2_62)) {
#ifdef QT_NO_DEBUG
aotContext->setInstructionPointer(64);
#endif
...
#endif
while (!aotContext->getObjectLookup(10, s.v2_62, &retrieved)) {
#ifdef QT_NO_DEBUG
aotContext->setInstructionPointer(66);
#endif
aotContext->initGetObjectLookup(10, s.v2_62);
if (aotContext->engine->hasError()) {
aotContext->setReturnValueUndefined();
return;
}
}
s.v2_64 = QVariant::fromValue(std::move(retrieved));
}
{
}
// generate_StoreReg
...
s.v2_68 = aotContext->engine->toScriptValue(QVariantMap {
{ QStringLiteral("fromPage"), std::move(s.v2_58) },
{ QStringLiteral("fromPagepath"), std::move(s.v2_64) },
});
{
}
// generate_StoreReg
...
{
const auto doCall = [&]() {
    QUrl arg0 = aotContext->engine->fromVariant<QUrl>(std::move(s.v7_21));
    void *args[] = {nullptr, &arg0, &s.v2_68};
    return aotContext->callObjectPropertyLookup(11, s.v2_49, args, 2);
};
const auto doInit = [&]() {
    aotContext->initCallObjectPropertyLookup(11, s.v2_49, 10);
};
#ifndef QT_NO_DEBUG
