...
0x1c,0xb,0x0,0x0,0x35,0x35,0x37,0x61,
...
#endif
while (!aotContext->loadAttachedLookup(13, aotContext->qmlScopeObject, &s.v2_4)) {
#ifdef QT_NO_DEBUG
aotContext->setInstructionPointer(6);
#endif
...
#endif
while (!aotContext->getObjectLookup(14, s.v2_4, &s.v2_6)) {
#ifdef QT_NO_DEBUG
aotContext->setInstructionPointer(8);
#endif
aotContext->initGetObjectLookup(14, s.v2_4);
if (aotContext->engine->hasError()) {
aotContext->setReturnValueUndefined();
return;
}
...
s.v2_19 = QUrl(QStringLiteral("qrc:/pages/nastaveniDesktop.qml"));
{
}
// generate_Jump
{
...
label_0:;
// generate_LoadRuntimeString
s.v2_23 = QUrl(QStringLiteral("qrc:/pages/nastaveniMobile.qml"));
{
...
#endif
while (!aotContext->setObjectLookup(15, s.v2_0, &s.c2_25)) {
#ifdef QT_NO_DEBUG
aotContext->setInstructionPointer(28);
#endif
