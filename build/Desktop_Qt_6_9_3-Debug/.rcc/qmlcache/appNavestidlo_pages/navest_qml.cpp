...
0x94,0xf,0x0,0x0,0x35,0x35,0x37,0x61,
...
s.v2_15 = QVariant::fromValue(QStringLiteral("qrc:/pages/navestDesktop.qml"));
{
}
// generate_Jump
{
...
label_0:;
// generate_LoadRuntimeString
s.v2_19 = QVariant::fromValue(QStringLiteral("qrc:/pages/navestMobile.qml"));
{
...
s.v2_62 = aotContext->engine->toScriptValue(QVariantMap {
{ QStringLiteral("nid"), std::move(s.v2_58) },
});
{
}
// generate_StoreReg
...
const auto doCall = [&]() {
    ...
    void *args[] = {nullptr, &arg0, &s.v2_62};
    return aotContext->callObjectPropertyLookup(9, s.v2_49, args, 2);
};
const auto doInit = [&]() {
    aotContext->initCallObjectPropertyLookup(9, s.v2_49, 10);
};
#ifndef QT_NO_DEBUG
...
aotContext->setInstructionPointer(2);
#endif
while (!aotContext->loadAttachedLookup(21, aotContext->qmlScopeObject, &s.v2_0)) {
#ifdef QT_NO_DEBUG
aotContext->setInstructionPointer(2);
#endif
