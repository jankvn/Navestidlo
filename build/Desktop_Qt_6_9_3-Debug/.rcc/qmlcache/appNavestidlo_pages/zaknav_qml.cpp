...
0x5c,0xc,0x0,0x0,0x35,0x35,0x37,0x61,
...
s.v2_15 = QUrl(QStringLiteral("qrc:/pages/zaknavDesktop.qml"));
{
}
// generate_Jump
{
...
label_0:;
// generate_LoadRuntimeString
s.v2_19 = QUrl(QStringLiteral("qrc:/pages/zaknavMobile.qml"));
{
...
// generate_Ret
if (argv[0]) {
    *static_cast<QUrl *>(argv[0]) = std::move(s.c2_21);
}
return;
}
...
aotContext->setInstructionPointer(2);
#endif
while (!aotContext->loadAttachedLookup(11, aotContext->qmlScopeObject, &s.v2_0)) {
#ifdef QT_NO_DEBUG
aotContext->setInstructionPointer(2);
#endif
