...
Page {
    ...
    property string pageName: "Testy"
    property string pageNamepath: "testy"
    ...
    Component.onCompleted:
    {
        ...
        ostatnilist.append({ nazev: "Nahlásit chybu", icon: vzhledAplikace.set, page: "aboutapp" })
            ...
            ColumnLayout {
                ...
                Rectangle {
                    ...
                    Column {
                        ...
                        spacing: 1
                        Text {
                            text: qsTr("Na této stránce se pracuje")
                            font.pixelSize: 16
                            color: vzhledAplikace.textc
...
/*                        Repeater {
                            ...
                            delegate: Rectangle {
                                ...
                                RoundedBackground {
                                    ...
                                    fillColor: parent.isHovered ? vzhledAplikace.buttonhover : vzhledAplikace.menubg
                                }
