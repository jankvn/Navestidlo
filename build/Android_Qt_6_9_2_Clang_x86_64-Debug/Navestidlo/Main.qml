...
ApplicationWindow {
    ...
    function hidebug()
    {
        if (stackView.currentItem.pageName === "Nahlásit chybu (Desktop)")
        {
        ...
        RowLayout {
            ...
            StackView {
                ...
                onCurrentItemChanged: {
                        if (stackView.currentItem.pageName === "Nahlásit chybu (Desktop)" || stackView.currentItem.pageName === "Nahlásit chybu (Mobilní)") {
                            repbugbtn.visible = false
                        } else {
