...
Page {
    ...
    property string pageName: "Základní návěsti (Desktop)"
                        ...
                        Text {
                            ...
                            MouseArea {
                                ...
                                onClicked: {
                                    ...
                                    Qt.openUrlExternally("https://navestidlo.kavjan.cz/?stranka=chyby&src=app&str=Základní%20návěsti");
                                }
                            }
                        }
                    }
            ...
            ComboBox {
                ...
                onActivated: {
                        ...
                        delegate: ItemDelegate {
                            ...
                            visible: model.key !== ""  // Skrýt první položku
                ...
                /*delegate: ItemDelegate {
                    ...
                    required property int index
                    width: control.width
                    visible: index !== 0  // Skrýt první položku
                    //width: control.width
                    contentItem: Text {
                        text: delegate.model[control.textRole]
                        color: vzhledAplikace.textc
                                ...
                                ColumnLayout {
                                    ...
                                    Rectangle {
                                        ...
                                        Text {
                                            ...
                                            //padding: 5
                                            color: vzhledAplikace.textc
                                            width: parent.width  // nebo Layout.fillWidth: true
                                        }
                                    }
                                }
                            /*Connections{
