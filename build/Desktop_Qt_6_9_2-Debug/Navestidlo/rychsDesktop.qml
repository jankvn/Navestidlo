...
Page {
    ...
    property string pageName: "Rychlostní soustava (Desktop)"
        ...
        GridLayout {
            ...
            Rectangle {
                ...
                Rectangle {
                    ...
                    Text {
                        anchors.right: parent.right      // přichytí k pravému okraji rodiče
                        anchors.rightMargin: 10          // mezera od pravého okraje
                        anchors.top: parent.top          // pokud chceš i nahoře
                        ...
                        MouseArea {
                            ...
                            onClicked: {
                                //Qt.openUrlExternally("https://navestidlo.kavjan.cz/?stranka=chyby&str=navest");
                                Qt.openUrlExternally("https://navestidlo.kavjan.cz/?stranka=chyby&src=app&str=Rychlostní%20soustava");
                            }
                        }
                    }
                }
        Rectangle{
            ...
            ComboBox {
                ...
                onActivated: {
                            nav.stopblikej()
                            xnav.stopblikej()
                            handler.vybratrychnav(control.currentIndex + 1, control2.currentIndex + 1)
                    ...
                    RowLayout {
                        ...
                        ColumnLayout {
                            ...
                            Rectangle {
                                Layout.fillWidth: true
                                //height: 100
                                Layout.preferredHeight: text9.implicitHeight
                                color: vzhledAplikace.headbg
                                Text {
                                    id: text9
                                    ...
                                    padding: 5
                                    color: vzhledAplikace.textc
                                    width: parent.width  // musí být pevně dané kvůli výpočtu implicitHeight
                                }
                            }
                        }
                    Connections{
