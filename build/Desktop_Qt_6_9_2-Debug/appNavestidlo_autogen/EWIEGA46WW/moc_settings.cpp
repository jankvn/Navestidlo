...
void settings::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->nastaveni((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 1: _t->vytahninastaveni(); break;
        case 2: { QString _r = _t->theme();
